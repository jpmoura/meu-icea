        ...
        <div class="box box-primary-ufop">
          ...
          <div class="box-body">
            <div class="text-center">
              ...
              <a class="btn btn-app" href="http://200.239.152.5/sisnti/web"><i class="fa fa-sign-in"></i>Entrar</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="box box-primary-ufop">
          ...
          <div class="box-body">
            <div class="text-center">
              ...
              <a class="btn btn-app" href="http://200.239.153.124/ajudai/public/middleware/{{ Session::get('id') }}"><i class="fa fa-sign-in"></i>Entrar</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="box box-primary-ufop">
          ...
          <div class="box-body">
            <div class="text-center">
              ...
              <a class="btn btn-app" href="http://200.239.153.124/owncloud"><i class="fa fa-sign-in"></i>Entrar</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-success" style="color: white" href="http://200.239.152.5/reserva/public/middleware/{{ Session::get('id') }}"><i class="fa fa-sign-in"></i> Entrar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="sobreSuporte" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
            <a class="btn btn-success" style="color: white" href="http://200.239.152.5/sisnti/web"><i class="fa fa-sign-in"></i> Entrar</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>Clique <a href="http://200.239.153.124/ajudai/public">aqui</a> para saber mais ainda.</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-danger pull-left" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
            <a class="btn btn-success" style="color: white" href="#"><i class="fa fa-sign-in"></i> Entrar</a>
