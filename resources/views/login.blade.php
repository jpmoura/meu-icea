...
<div class="login-box">
    <div class="login-logo">
        <i class="fa fa-building-o"></i> Meu <span class="text-bold">ICEA</span>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body ufop-border">
        <p class="login-box-msg">Faça o login para acessar todos os serviços disponíveis no campus.</p>
        <div class="form">
...
<footer class="text-center">
    <!-- Default to the left -->
    <strong>Copyleft <i class="fa fa-creative-commons"></i> {{ date("Y") }} <a href="https://github.com/jpmoura/meu-icea">Meu ICEA</a></strong>.
</footer>
