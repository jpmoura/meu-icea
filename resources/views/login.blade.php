...
<body class="hold-transition login-page skin-ufop guest">
  <div class="login-box">
    <div class="login-logo">
      <i class="fa fa-building-o"></i> Meu <b>ICEA</b>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body ufop-border">
      ...
      <div class="form">
        <form class="form" action="{{url('/login')}}" method="post">
          ...
          @endif
          <br />
          <button type="submit" class="btn btn-primary-ufop center-block btn-block"><i class="fa fa-sign-in"></i> Entrar</button>
        </form>
      </div>
    </div>
  </div>
  ...
  <footer class="text-center">
    <!-- Default to the left -->
    <strong>Copyleft <i class="fa fa-creative-commons"></i> {{ date("Y") }} <a href="#">NTI ICEA</a></strong>.
  </footer>
  <!-- jQuery 2.1.3 -->
